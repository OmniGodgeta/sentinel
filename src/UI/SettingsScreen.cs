...
public sealed partial class SettingsScreen : CanvasLayer
{
    ...
    public override void _Ready()
    {
        ...
        var root = new VBoxContainer { CustomMinimumSize = new Vector2(784, 0) };
        ...
        var vol = new HSlider { MinValue = 0, MaxValue = 1, Step = 0.05, Value = o.SfxVolume, CustomMinimumSize = new Vector2(0, 67) };
        vol.ValueChanged += v =>
        {
        ...
        var mvol = new HSlider { MinValue = 0, MaxValue = 1, Step = 0.05, Value = o.MusicVolume, CustomMinimumSize = new Vector2(0, 67) };
        mvol.ValueChanged += v =>
        {
