...
public sealed partial class LoginScreen : CanvasLayer
{
    ...
    public override void _Ready()
    {
        ...
        _email = new LineEdit { PlaceholderText = "email", CustomMinimumSize = new Vector2(0, 56) };
        _email.AddThemeFontSizeOverride("font_size", 18);
        col.AddChild(_email);

        _password = new LineEdit { PlaceholderText = "password (6+ chars)", Secret = true, CustomMinimumSize = new Vector2(0, 56) };
        _password.AddThemeFontSizeOverride("font_size", 18);
        ...
        var loginBtn = new Button { Text = "Log In", CustomMinimumSize = new Vector2(0, 62) };
        loginBtn.AddThemeFontSizeOverride("font_size", 19);
        UiTheme.StylePrimary(loginBtn);
        loginBtn.Pressed += () => Attempt(signUp: false);
        col.AddChild(loginBtn);

        var signupBtn = new Button { Text = "Create Account", CustomMinimumSize = new Vector2(0, 56) };
        signupBtn.AddThemeFontSizeOverride("font_size", 17);
        signupBtn.Pressed += () => Attempt(signUp: true);
        col.AddChild(signupBtn);

        var skip = new Button { Text = "Skip — play as guest", CustomMinimumSize = new Vector2(0, 50), Flat = true };
        skip.AddThemeFontSizeOverride("font_size", 15);
